...
if __name__ == "__main__":
    ...
    out_dir = sys.argv[12]
    denovo_output_file = out_dir + sys.argv[14] + ".txt"
    ...
    for chr_num in range(chr_start,chr_end+1): 
        ...
        twohps_vcf = out_dir + "hp_chr" + str(chr_num) + ".vcf"
        print("processing chr" + str(chr_num) + "..." )
        try:
            count_lowconf = find_denovo_mut(phased_vcf,twohps_vcf,reads_depth,fw, child_num, parent1_num, parent2_num,denovo_raw_file)
        except:
